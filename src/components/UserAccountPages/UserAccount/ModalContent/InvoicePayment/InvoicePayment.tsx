...
const data = [
  { id: 0, apartment: "4-комн. апартаменты на Грушевке", address: "Чиланзар, д. 10" },
  { id: 1, apartment: "4-комн. апартаменты на Грушевке длинное название объекта", address: "Чиланзар, д. 10" },
  { id: 2, apartment: "4-комн. апартаменты на Грушевке длинное название объекта", address: "Чиланзар, д. 10" },
  { id: 3, apartment: "4-комн. апартаменты на Грушевке", address: "Чиланзар д. 10" },
  { id: 4, apartment: "4-комн. апартаменты на Грушевке", address: "Чиланзар, д. 10" },
]
