          ...
          <div className={classes.mainContent}>
            ...
            <div className={classes.cardData}>
              ...
              <div className={classes.description}>
                ...
                Большая четырехкомнатная студия! Большая джкакузи на двоих, на теливизоре есть приложение Megogo, YouTube, Smart TV, сможете выбрать фильм по вкусу! Цена зависит от количества проживающих, уточняйте, пожалуйста, по телефону! В пяти минутах ходьбы Чиланзар, Виктория Олимп отель. Также недалеко находятся Аквапарк Лебяжий, Dreamland Park , Парк Победы, Стелла! До ЖД вокзала 15 минут езды на автобусе. Будем рады Вас видеть у нас в гостях, расскажу,что можно в нашем городе посмотреть, а также могу заранее забронировать экскурсии! Все отчетные документы , временная регистрация предоставляется. В квартире Не курят.
